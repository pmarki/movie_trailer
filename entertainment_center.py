...
"""copy next line and fill in with your favourite movie details. Take a look at samples provided. Then add it to move list below
...
"""createing movie list beacuse open_movies_pages requires list as a parameter"""
